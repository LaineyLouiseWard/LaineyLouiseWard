...
\node[text width=3.8cm, align=left, anchor=west, font=\sffamily, inner sep=0pt]
    (item2) at (0, -0.8)
    {{\color{coneRed}\faSearch}\hspace{0.3em} Create DFT event catalogue; link to catchment and soil properties};
\node[text width=4.5cm, align=center, anchor=west, font=\sffamily\bfseries, inner sep=0pt]
    (item3) at (4.85, 0)
    {{\color{posternavy}\faMapMarker*}\hspace{0.2em} Identify predictable \mbox{at-risk} catchments};
