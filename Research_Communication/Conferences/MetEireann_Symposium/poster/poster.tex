...
We evaluate ECMWF extended-range and seasonal reforecasts using probabilistic (Fair CRPSS [4]) and deterministic (ACC) metrics for 2\,m temperature at weekly lead times.
...
\item {\color{coneRed}\faSearch}\hspace{0.4em} Build Irish DFT event catalogue from observations
\item {\color{gray}\faMapMarkerAlt}\hspace{0.4em} Identify where forecast skill coincides with event occurrence
