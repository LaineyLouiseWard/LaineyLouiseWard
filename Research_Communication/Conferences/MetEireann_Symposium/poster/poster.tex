...
\includegraphics[width=\linewidth]{poster_fig_rankhist.png}
\end{minipage}%
\hfill
\begin{minipage}[c]{0.24\linewidth}
\raggedright
{\small \textbf{Fig.\ 2:} Rank histograms; raw vs seasonal LOYO bias-corrected.}
\end{minipage}

\vspace{0.2em}
\tikz[remember picture] \coordinate (fig4anchor) {};%
\vspace{0.2em}
...
\begin{minipage}[c]{0.24\linewidth}
\raggedright
{\small \textbf{Fig.\ 3:} ACC vs lead time.}
\end{minipage}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.44\linewidth}
\vspace{0pt}
\includegraphics[width=\linewidth]{poster_fig_crpss.png}
\end{minipage}

\begin{tikzpicture}[remember picture, overlay]
\node[anchor=east, text width=3.5cm, align=right, font=\small]
    at ([xshift=12.3cm, yshift=-0.55cm]fig4anchor)
    {\textbf{Fig.\ 4:} Fair CRPSS across lead time (bias-corrected).};
% --- Interpretation box in bottom-right whitespace ---
\node[anchor=north west, text width=9.5cm, align=left, font=\small,
      draw=drivcol!70, fill=drivcol!8, rounded corners=4pt,
      inner xsep=6pt, inner ysep=5pt]
    at ([xshift=12.0cm, yshift=-2.8cm]fig4anchor)
    {%
    \begin{itemize}[leftmargin=1em, itemsep=0.1em, topsep=0em]
    \item Your interpretation here
    \item Your interpretation here
    \item Your interpretation here
    \end{itemize}
    };
