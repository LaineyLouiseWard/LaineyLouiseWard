...
We verify 2\,m temperature forecasts at \textbf{2--6 week} lead time using probabilistic and deterministic metrics: \textbf{Fair CRPSS} (Continuous Ranked Probability Skill Score) [4] and \textbf{ACC} (Anomaly Correlation Coefficient). CRPSS is bias-corrected via leave-one-year-out to isolate skill from systematic error.
...
%----------------------------------------------------------------------
\headerbox{Discussion \& Future Work}{name=discussion,column=0,below=results,span=2}{
...
%----------------------------------------------------------------------
\headerbox{References}{name=references,column=2,span=1,below=results,bottomaligned=discussion}{
