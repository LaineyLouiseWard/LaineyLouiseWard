...
\begin{itemize}[leftmargin=0em, itemsep=1.0em, parsep=0pt, topsep=0pt, label={}]
...
\begin{minipage}[t]{0.47\linewidth}
\begin{itemize}[leftmargin=0em, itemsep=1.0em, parsep=0pt, topsep=0pt, label={}]
\item {\color{drivcol}\faIcon{exchange-alt}}\hspace{0.4em} Compare with SEAS5 seasonal model to identify skill overlap across timescales
