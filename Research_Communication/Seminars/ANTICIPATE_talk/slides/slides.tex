    ...
    \begin{columns}[c, totalwidth=\textwidth]
        ...
        \begin{column}{0.43\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node[font=\tiny, text=gray!80, align=center]
                    at (0, -0.4) {economic losses \&\\affected populations};
                \node[font=\tiny, text=gray!55]
                ...
                \node[font=\large\bfseries, text=statred!80!black]
                    at (0, -2.1) {{$\sim$}2{$\times$}};
                \node[font=\tiny, text=gray!80, align=center]
                    at (0, -2.6) {compound events\\by 2050};
                \node[font=\tiny, text=gray!55]
...
% --------------------------------------------------
% SLIDE 3: What does the research look like?
% --------------------------------------------------
\begin{frame}{What Does the Research Look Like?}

    \centering
    \vspace{-0.3em}
    \includegraphics[width=\textwidth, keepaspectratio]
        {tradition_mosaic.png}
...
\begin{frame}{Is This Forecastable?}
    ...
    \node[font=\scriptsize\bfseries, text=slideblue!70!black,
          above=0.1cm of b1] {A predictable driver};
    }
    ...
    \begin{columns}[c, totalwidth=\textwidth]
        ...
        \begin{column}{0.68\textwidth}
            ...
            \node[iconcirc, draw=statred!50, fill=statred!10] (i1) at (-3.5, 1.8)
                {\Large\color{statred!70!black}\faGlobe};
            \node[lbl] at (-2.4, 1.8)
                {Same phenomenon, four distinct traditions};
