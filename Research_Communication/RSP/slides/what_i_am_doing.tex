...
\begin{frame}{Observation--Forecast Temperature Chain}
    ...
    \begin{columns}[c, totalwidth=\textwidth]
        ...
        \begin{column}{\textwidth}
            \centering
            \includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{consolidation_raw_t2m_chain.png}
        \end{column}
...
% --------------------------------------------------
% SLIDE 5: Deterministic verification results
% --------------------------------------------------
% PURPOSE: Station-level and spatial verification plots.
%          Script: "At the station level, both systems are verified
%          against Met Éireann observations. Spatially, they're
%          verified against ERA5-Land."
% --------------------------------------------------
\begin{frame}{Deterministic Verification}
...
% --------------------------------------------------
% SLIDE 6: Spatial Bias — dual reference
% --------------------------------------------------
\begin{frame}{Spatial Verification}
    ...
    \begin{columns}[c, totalwidth=\textwidth]
        ...
        \begin{column}{\textwidth}
            \centering
            \includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{consolidation_spatial_bias_4panel.png}
        \end{column}
...
% --------------------------------------------------
% HIDDEN SLIDES: Spatial RMSE + RMSS
% --------------------------------------------------
\appendix
